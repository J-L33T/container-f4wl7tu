...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-f4wl7tu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-f4wl7tu.containers.anotherwebservice.com/
...
```
git clone git@github.com:J-L33T/container-f4wl7tu.git
cd container-f4wl7tu
```
...
```
docker attach container-f4wl7tu
```
